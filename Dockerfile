...
COPY wp-bypass-nonces.patch /tmp/wp-bypass-nonces.patch
...
RUN git clone -b main https://github.com/david-prv/atropos-instrumentation.git /tmp/atropos-instrumentation && \
